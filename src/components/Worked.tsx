...
export const Worked: React.FC<CardProps> = ({ data }) => {
  ...
  return (
    <div
      className='font-Lexend block md:flex gap-0 md:gap-8 w-full px-0 md:px-6 py-6 my-6 rounded-md shadow-md dark:shadow-light-shadow transition-all cursor-pointer'
