...
export const About: FC = () => {
  return (
    <div className='leading-relaxed min-h-dvh'>
      <h2 className='text-sm font-bold uppercase tracking-widest text-slate-200 lg:sr-only my-6'>About</h2>
      <p className='mb-4'>
      ...
      <p className='mb-4'>
        ...
        molestias repellat temporibus hic illum, modi beatae dignissimos labore? Sint enim officiis laudantium repellat
        voluptatibus eaque!
      </p>
